...
<!-- suchana/coming-soon.html  22 Nov 2019 04:16:29 GMT -->
<head>
        ...
        <div class="container">
            <div class="coming-main text-center">
                <div class="coming-content mar-bottom-20">
                    <img src="images/logo.png" class="mar-bottom-30">
                    <h1 class="white">Coming Soon</h1>

                    <p class="white">Our website is currently undergoing scheduled maintenance. We Should be back shortly. Thank you for your patience.</p>
                </div>
                ...
                <form>
                    <div class="mailpoet_form">
                        <form target="_self" method="post" action="#" novalidate="">
                            ...
                            <div class="button mar-top-30"><input type="submit" class="btn-blog" value="Subscribe!"></div>
                        </form>
                    </div>     
                </form>
...
<!-- suchana/coming-soon.html  22 Nov 2019 04:16:31 GMT -->
</html>